...
class Scratch2 {
        ...
        do {
            do{
                try {
                   ...
                   if(userInputInt > 2 || userInputInt <= 0)
           ...
           switch (userInputInt) {
               ...
               case 1->{
                   ...
                   if (userInputString.equals("admin") && userPassword.equals("admin")){ //admin login check
                       admin = true;
    ...
    public static void SecondPage(){
        ...
        boolean exit = false;
        while (!exit){
            setBalance(userNameFinal);//change the balance in each iteration
            //Names of locations
        ...
        if (Searchin.equals("accounts")){
            try {
                try (Scanner reader = new Scanner(fileToCheck)) {
                    ...
                    reader.close();
                    if (exist) {
                        System.out.println(foundCounter + " records were found.");
                    }
                }
            ...
            try (Scanner reader = new Scanner(accounts)) {
                ...
                while (reader.hasNext()) {
                    ...
                    if (userName1.equals(userName) && password1.equals(password)) {
                        ...
                        setBalance(userName); // method called
                        return true;
                    }
                }
            }
    ...
    public static boolean  signUp (String userName , String password) throws IOException {
        ...
        do {
            try {
                userInputInt =  Integer.parseInt(inputString());
                if (userInputInt < 18){
                    System.out.println("to have an account you must be over 18");
                    return false;
                }else break;
