...
class Scratch2 {
        ...
        do {
           ...
           switch (userInputInt) {
               ...
               case 1->{
                   ...
                   if (signIn(userInputString, userPassword) && userInputString.equals("admin")){ //admin login check
                       System.out.println("Welcome admin");
                       adminPage();// method called
                   } else if(!signIn(userInputString, userPassword)) // method called
    ...
    public static void deleteRecord (String userName,File fileToCheck){
        try {
            ...
            String []arrayBalance = new String[counter / 2 - 2];
                        ...
                        case 1 -> {
                            do {
                                ...
                                if (checkPasswordStrength(change)) {
                                    ...
                                    System.out.println("Password updated. please restart to save changes");
                                    break;
                                }
                            }
                            while (true);
                        ...
                        case 2 -> {
                            do {
                                ...
                                if (!CheckIfRecordExist("", accounts, change, "accounts")) {
                                    ...
                                    System.out.println("please restart to save changes");
                                    break;
                                } else {
